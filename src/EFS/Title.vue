<template>
  <div class="title" :class="{ active }">
    ...
    <svg width="100%" height="100%" viewBox="0 0 1920 1080">
      ...
      <defs>
        <mask id="mask" width="1920" height="1080">
        ...
        <mask id="titlemaskInverted">
          <rect fill="white" y="55" x="55" width="1810" height="970"/>
          <rect fill="black" y="55" x="55" width="1810" height="970" mask="url(#mask)"/>
          <rect fill="black" y="55" x="55" width="1810" height="970" mask="url(#titlemask)"/>
        </mask>
      </defs>

      <rect class="invertedtext" fill="white" y="55" x="55" width="1810" height="970" mask="url(#titlemaskInverted)"/>

      <g mask="url(#mask)" x="0" y="0" width="1920" height="1080">
        <rect mask="url(#titlemask)" fill="white" width="1920" height="1080"/>
