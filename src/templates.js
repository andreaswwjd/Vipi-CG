...
export default {
  EFS_Bild: {
    component: () => import('./EFS/Bild'),
    title: 'Bild',
    placeholders: { file: 'Filnamn (i "media"-mappen)' },
  },
  EFS_Intro: {
    component: () => import('./EFS/Intro'),
    title: 'Intro',
    placeholders: { file: 'Filnamn (i "media"-mappen)' },
  },
  EFS_Slideshow_start: {
    component: () => import('./EFS/Slideshow_start'),
    title: 'Slideshow (start)',
    placeholders: { duration: 'Duration (default 5s)' },
  },
  EFS_Title: {
  ...
  // },
  // Sangplatta: {
  //   component: () => import('./components/Sangplatta'),
  //   title: 'Sångplatta',
  //   placeholders: {},
  // },
  // EFS_Bibelord: {
